				...
				<div class="row block block-info">
					<div class="form-inline">
						<div class="pull-right pad">
							<form name=""
								action="http://www.sdutacm.org/onlinejudge2/index.php/Home/Contest/contestlist"
								method="get">
								...
								<div class="input-group input-group-sm">
									<span class="input-group-addon">Type</span> <select
										class="form-control" name="contesttype">
								...
								<div class="input-group input-group-sm">
									<span class="input-group-addon"><i
										...
										placeholder="Contest ID" name="cid" value="">
								</div>
						...
						<tfoot>
							...
							-->
										...
										<script type="text/javascript">
											$(".bootpage div").addClass(
													"btn-group btn-group-sm");
											$(".bootpage a").addClass(
													"btn btn-default");
											$(".bootpage span").addClass(
													"btn btn-primary");
										</script>
									</div></td>
							</tr>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-11 text-center">
						<a
							href="http://www.sdutacm.org/onlinejudge2/index.php/Home/Contest/contestlist#">LDUACMè¿ç»´ææ¯ä¸­å¿</a>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-11 text-center">
